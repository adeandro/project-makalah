...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-800">
      {/* HEADER */}
      <header className="p-6 text-center bg-white shadow">
        <h1 className="text-6xl uppercase font-bold text-cyan-600">
          Galeri Proyek Siswa
        </h1>
      ...
      {/* MAIN CONTENT */}
      <main className="max-w-4xl mx-auto mt-8 p-6 bg-white shadow rounded-2xl">
